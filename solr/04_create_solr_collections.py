...
import json
import os
from coreconfigs import _FTBASE

def create_solr_collection(solr_endpoint, collection_name):
    url = f"{_FTBASE[0]}admin/collections?action=CREATE&name={collection_name}&numShards=1&replicationFactor=1&wt=xml"
    print(url)
...
solr_endpoint = {_FTBASE[0]}  # Replace with your Solr server URL
collection_name = "searchdocuments"  # Replace with your collection name
